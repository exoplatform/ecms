...
public class HyperLinkUtil extends AttributeUtil
{
   ...
   public synchronized void createFullLink(HTMLNode node, Map<String, String> map, URL home, URLCreator creator,
   ...
   private class SiteLinkVerifier extends TextVerifier implements ValueVerifier
   {
      public boolean verify(String link)
      {
         ...
         String end[] =
            {"css", "js", "jpg", "gif", "jpeg", "bmp", "dat", "exe", "txt", "java", "pdf", "doc", "rm", "ram", "wma",
               "wmv", "mp3", "swf", "zip", "jar", "rar"};

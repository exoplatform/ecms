...
public class HttpClientImpl
{
   ...
   public GetMethod getMethod(String link) throws Exception
   {
      ...
      if (link.startsWith("http://") || link.startsWith("shttp://"))
      {
         ...
         if (!url.getHost().toLowerCase().equals(http.getHostConfiguration().getHost().toLowerCase()))
         {
            return null;
         }
      }
      ...
      {
         if (!link.toLowerCase().equals(http.getHostConfiguration().getHost().toLowerCase()))
         {
            return null;
         }
      }

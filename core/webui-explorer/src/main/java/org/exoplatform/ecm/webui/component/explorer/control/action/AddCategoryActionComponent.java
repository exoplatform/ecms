...
@ComponentConfig(
    events = {
        @EventConfig(listeners = AddCategoryActionComponent.AddCategoryActionListener.class)
    }
)
public class AddCategoryActionComponent  extends UIComponent {

  private static final List<UIExtensionFilter> FILTERS = Arrays.asList(new UIExtensionFilter[] {
      new CanAddNodeFilter(), new IsNotLockedFilter(), new IsCheckedOutFilter(),
      new CanAddCategoryFilter(), new IsNotEditingDocumentFilter() });
  ...
  public static void addFolder(Event<? extends UIComponent> event, UIJCRExplorer uiExplorer) throws Exception {
    ...
    UIPopupContainer.activate(UICategoryForm.class, 600);
    event.getRequestContext().addUIComponentToUpdateByAjax(UIPopupContainer);
  }


  public static class AddCategoryActionListener extends UIActionBarActionListener<AddCategoryActionComponent> {
    @Override

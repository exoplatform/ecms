...
public class UIAddTranslationManager extends UIContainer implements UIPopupComponent {
  private static final Log LOG  = ExoLogger.getLogger(UIAddTranslationManager.class.getName());

  final static public String EXTARNAL_METADATA_POPUP = "AddMetadataPopup" ;

  public UIAddTranslationManager() throws Exception {
    addChild(UIAddTranslationForm.class, null, null);
  ...
  public void activate() {
    try {
      UIAddTranslationForm uiUploadForm = getChild(UIAddTranslationForm.class);
  ...
  public void useWorkspaceSelector() {
    UIAddTranslationForm child = getChild(UIAddTranslationForm.class);
    if (child!=null)  {

 ...
 * Jul 14, 2009
 */
public class TestWCMCoreUtils extends BaseWCMTestCase {
  ...
  public void testGetReferencedContent1() throws Exception {
    ...
    Node resultNode = WCMCoreUtils.getReferencedContent(WCMCoreUtils.getSystemSessionProvider(), COLLABORATION_WS, nodePath);
  ...
  public void testGetReferencedContent2() throws Exception {
    ...
    Node resultNode = WCMCoreUtils.getReferencedContent(WCMCoreUtils.getSystemSessionProvider(), COLLABORATION_WS, nodeUUID);
  ...
  public void testGetReferencedContent3() throws Exception {
    ...
    Node resultNode = WCMCoreUtils.getReferencedContent(WCMCoreUtils.getSystemSessionProvider(), COLLABORATION_WS, nodeIdentifier);

...
public class CloudDriveEvent {
   ...
   * @param workspace {@link String}
   * @param nodePath {@link String}
   * @param clouddriveTitle {@link String}
   */
  public CloudDriveEvent(CloudUser user, String workspace, String nodePath, String clouddriveTitle) {
    this.user = user;
    this.workspace = workspace;
    this.nodePath = nodePath;
    this.changed = Collections.emptyList();
    this.removed = Collections.emptyList();
    this.title = clouddriveTitle;
  }

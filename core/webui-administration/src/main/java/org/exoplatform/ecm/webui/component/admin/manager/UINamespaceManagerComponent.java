...
@ComponentConfig(
     events = {
       @EventConfig(listeners = UINamespaceManagerComponent.UINamespaceManagerActionListener.class)
     }
 )
public class UINamespaceManagerComponent extends UIAbstractManagerComponent {

  public static class UINamespaceManagerActionListener extends UIECMAdminControlPanelActionListener<UINamespaceManagerComponent> {
    public void processEvent(Event<UINamespaceManagerComponent> event) throws Exception {
  ...
  public Class<? extends UIAbstractManager> getUIAbstractManagerClass() {
    return UINamespaceManager.class;
  }
}

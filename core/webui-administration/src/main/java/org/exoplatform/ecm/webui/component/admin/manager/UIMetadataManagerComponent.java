...
@ComponentConfig(
     events = {
       @EventConfig(listeners = UIMetadataManagerComponent.UIMetadataManagerActionListener.class)
     }
 )
public class UIMetadataManagerComponent extends UIAbstractManagerComponent {

  public static class UIMetadataManagerActionListener extends UIECMAdminControlPanelActionListener<UIMetadataManagerComponent> {
    public void processEvent(Event<UIMetadataManagerComponent> event) throws Exception {

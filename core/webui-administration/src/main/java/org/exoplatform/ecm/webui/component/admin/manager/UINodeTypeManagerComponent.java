...
@ComponentConfig(
     events = {
       @EventConfig(listeners = UINodeTypeManagerComponent.UINodeTypeManagerActionListener.class)
     }
 )
public class UINodeTypeManagerComponent extends UIAbstractManagerComponent {

  public static class UINodeTypeManagerActionListener extends UIECMAdminControlPanelActionListener<UINodeTypeManagerComponent> {
    public void processEvent(Event<UINodeTypeManagerComponent> event) throws Exception {
  ...
  public Class<? extends UIAbstractManager> getUIAbstractManagerClass() {
    return UINodeTypeManager.class;
  }
}

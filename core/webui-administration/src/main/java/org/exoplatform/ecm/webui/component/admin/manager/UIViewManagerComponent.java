...
@ComponentConfig(
     events = {
       @EventConfig(listeners = UIViewManagerComponent.UIViewManagerActionListener.class)
     }
 )
public class UIViewManagerComponent extends UIAbstractManagerComponent {

  public static class UIViewManagerActionListener extends UIECMAdminControlPanelActionListener<UIViewManagerComponent> {
    public void processEvent(Event<UIViewManagerComponent> event) throws Exception {

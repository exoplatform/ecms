...
@ComponentConfig(
     events = {
       @EventConfig(listeners = UIScriptManagerComponent.UIScriptManagerActionListener.class)
     }
 )
public class UIScriptManagerComponent extends UIAbstractManagerComponent {

  public static class UIScriptManagerActionListener extends UIECMAdminControlPanelActionListener<UIScriptManagerComponent> {

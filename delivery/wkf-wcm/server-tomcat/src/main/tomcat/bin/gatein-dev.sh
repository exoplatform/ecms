...
EXO_CONFIG_OPTS="-Xshare:auto -Xms128m -Xmx512m -XX:MaxPermSize=512m -Dorg.exoplatform.container.configuration.debug"
...
JAVA_OPTS="$YOURKIT_PROFILE_OPTION $JAVA_OPTS $LOG_OPTS $SECURITY_OPTS $EXO_OPTS $EXO_CONFIG_OPTS $BONITA_OPTS $REMOTE_DEBUG"
export JAVA_OPTS

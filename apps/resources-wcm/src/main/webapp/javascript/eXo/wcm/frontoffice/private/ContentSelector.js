        ...
        tdNoContent.setAttribute("userLanguage", "UserLanguage.NoContent");
			...
			for(var i = 0; i < list.length; i++) {      
				...
				if(viewType=="list") {	        
					...
					gj(newRow.insertCell(0)).html('<a class="Item" url="'+decodeURIComponent(url)+'" path="'+path+'" nodeType="'+nodeType+'" style = "overflow:hidden;" rel="tooltip" data-placement="bottom" title="'+decodeURIComponent(node)+'" onclick="eXo.ecm.ECS.insertContent(this);">'+decodeURIComponent(node)+'</a>');

(function(gj, wcm_utils) {
    ...
    var displayMode;
    if(gj("input:radio[name=UICLVConfigDisplayModeFormRadioBoxInput]:checked").val() == "AutoViewerMode"){
      displayMode="folder";
    }
	  ...
	  if(dropdownlist) {
		...
		var url = ECS.hostName + ECS.connector+command+"&filterBy="+filter+"&type="+displayMode;

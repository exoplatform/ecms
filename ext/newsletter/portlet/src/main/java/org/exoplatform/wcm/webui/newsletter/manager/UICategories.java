...
public class UICategories extends UIContainer {
	...
	public long getNumberOfWaitingNewsletter(String categoryName,
		...
		try {
			return subscriptionHandler.getNumberOfNewslettersWaiting(Utils
					.getSessionProvider(), portalName, categoryName,
					subscriptionName);
		} catch (Exception ex) {
			return 0;
		}
	...
	public int getNumberOfUser(String categoryName, String subscriptionName) {
		return userHandler.getQuantityUserBySubscription(Utils
				.getSessionProvider(), portalName, categoryName,
				subscriptionName);
	}
   ...
   * method is invoked.
	...
	static public class OpenCategoryActionListener extends
		...
		public void execute(Event<UICategories> event) throws Exception {
			...
			subsriptions.setCategory(uiCategories.categoryHandler
					.getCategoryByName(Utils.getSessionProvider(),

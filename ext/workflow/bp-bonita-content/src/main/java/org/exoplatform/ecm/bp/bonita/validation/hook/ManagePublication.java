...
public class ManagePublication implements TxHook {
  ...
  private void publishContent(APIAccessor api, ActivityInstance<ActivityBody> activity) throws Exception{    
	    ...
	    String publishWorkspace=(String)api.getQueryRuntimeAPI().getProcessInstanceVariable(activity.getProcessInstanceUUID(),"exo:publishWorkspace");
	    String publishPath = (String)api.getQueryRuntimeAPI().getProcessInstanceVariable(activity.getProcessInstanceUUID(),"exo:publishPath");

...
public class TrashMovement implements TxHook{
	...
	private void moveTrash(APIAccessor api, ActivityInstance<ActivityBody> activity) throws Exception {
	    ...
	    String trashWorkspace = (String)api.getQueryRuntimeAPI().getProcessInstanceVariable(activity.getProcessInstanceUUID(),"exo:trashWorkspace");
	    String trashPath = (String)api.getQueryRuntimeAPI().getProcessInstanceVariable(activity.getProcessInstanceUUID(),"exo:trashPath");

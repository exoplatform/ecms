 ...
 * Sep 6, 2008
 */
public class CreatePortalPublicationPlugin extends CreatePortalPlugin {
   ...
   */
  public CreatePortalPublicationPlugin(InitParams initParams,
  ...
  public void deployToPortal(SessionProvider sessionProvider, String portalName) throws Exception {
    PublicationUtils.deployPublicationToPortal(initParams, repositoryService, wcmPublicationService, sessionProvider, portalName);
  }
}

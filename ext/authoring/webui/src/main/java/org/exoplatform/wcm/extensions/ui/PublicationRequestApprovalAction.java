...
public class PublicationRequestApprovalAction extends UIComponent {
  ...
  private static final List<UIExtensionFilter> FILTERS = Arrays.asList(new UIExtensionFilter[] {
      new CanAddNodeFilter(), new IsNotLockedFilter(), new IsCheckedOutFilter(), new CanValidateFilter(), new IsNotIgnoreVersionNodeFilter(),new IsNotEditingDocumentFilter()});

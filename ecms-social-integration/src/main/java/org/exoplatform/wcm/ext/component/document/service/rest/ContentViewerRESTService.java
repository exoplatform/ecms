...
public class ContentViewerRESTService implements ResourceContainer {
  ...
  public ContentViewerRESTService(WebAppController webAppController, RepositoryService repositoryService, LinkManager linkManager)
      throws Exception {
  ...
  public Response getContent(@Context
  HttpServletRequest request,
    ...
    try {
      ...
      uiDocViewer.setDocPath(contentNode.getPath());
      uiDocViewer.setRepository(repository.getConfiguration().getName());
      uiDocViewer.setWorkspace(workspaceName);

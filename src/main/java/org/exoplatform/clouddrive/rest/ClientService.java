...
/**
 * Custom client code (Javascript) for given provider.<br>
 * 
 ...
 * 
 */
@Path("/clouddrive/client/")
@Produces(MediaType.APPLICATION_JSON)
public class ClientService implements ResourceContainer {

  protected static final Log             LOG = ExoLogger.getLogger(ClientService.class);
   ...
   * 
   */
  public ClientService(CloudDriveService cloudDrives,

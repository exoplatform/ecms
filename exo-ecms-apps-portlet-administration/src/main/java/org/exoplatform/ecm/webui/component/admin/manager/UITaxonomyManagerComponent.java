...
@ComponentConfig(
     events = {
       @EventConfig(listeners = UITaxonomyManagerComponent.UITaxonomyManagerActionListener.class)
     }
 )
 @Deprecated
public class UITaxonomyManagerComponent extends UIAbstractManagerComponent {

  public static class UITaxonomyManagerActionListener extends UIECMAdminControlPanelActionListener<UITaxonomyManagerComponent> {
    public void processEvent(Event<UITaxonomyManagerComponent> event) throws Exception {
  ...
  public Class<? extends UIAbstractManager> getUIAbstractManagerClass() {
    return UITaxonomyManager.class;
  }  
}
